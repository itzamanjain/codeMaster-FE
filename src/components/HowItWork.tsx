export function HowItWork (){
   const steps = [
    ...
    return (
      <section className="  bg-gradient-to-t from-[#020817] to-[#0F172A] py-6 md:py-10 ">
        <div className="flex flex-col items-center m-auto text-center gap-4 max-w-[1024px]">
          ...
          Follow these simple steps to get started, compete in challenges, and track your progress on Code Master.
          </div>
