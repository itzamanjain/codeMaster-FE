...
export function Hero() {
  return (
    <section className="bg-[#020817] dark:bg-[#020817] m-4 md:m-0 py-4 md:py-6">
      <div className="mx-auto px-4 md:px-6 flex flex-col justify-center items-center gap-0">
        <div className="flex flex-col justify-center text-center gap-3 ">
          ...
          <div className="text-6xl text-[#4E7AFF] font-bold">Code Master</div>
          <div className="text-sm text-gray-600">Join elite coders, solve problems, and climb leaderboards at Code Master </div>
